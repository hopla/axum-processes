...
**
** Created: Tue Apr 28 12:04:15 2009
...
static const char qt_meta_stringdata_Browser[] = {
    "Browser\0\0MeterRelease()\0SecondTimerTick()\0"
    "ReadNetwork()\0"
};
...
void *Browser::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::Browser"))
        return static_cast< Ui::Browser*>(const_cast< Browser*>(this));
...
int Browser::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: MeterRelease(); break;
        case 1: SecondTimerTick(); break;
        case 2: ReadNetwork(); break;
        default: ;
        }
        _id -= 3;
    }
