/****************************************************************************
** Meta object code from reading C++ file 'DNREnginePlugin.h'
**
** Created: Mon Oct 22 15:13:45 2007
...
#error "The header file 'DNREnginePlugin.h' doesn't include <QObject>."
...
void *EnginePlugin::qt_metacast(const char *_clname)
{
	...
	return static_cast<QDesignerCustomWidgetInterface*>(const_cast<EnginePlugin*>(this));
